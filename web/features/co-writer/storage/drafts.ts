...
export const DRAFT_STORAGE_PREFIX = "deepmentor.co_writer.draft.v2.";
export const LEGACY_DRAFT_STORAGE_PREFIX = "deepmentor.co_writer.draft.";
export const SPLIT_RATIO_KEY = "deepmentor.co_writer.split_ratio.v2";
export const SYNC_SCROLL_KEY = "deepmentor.co_writer.sync_scroll.v2";
