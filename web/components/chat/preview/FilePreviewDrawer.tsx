...
export default function FilePreviewDrawer({
  ...
  return (
    <div
      ...
      className={`fixed right-0 top-[var(--top-banner-h)] z-40 flex h-[calc(100dvh-var(--top-banner-h))] w-full flex-col border-l border-[var(--border)] bg-[var(--card)] transition-transform ease-out md:w-[min(560px,92vw)] ${
