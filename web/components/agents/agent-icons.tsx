...
function OfficialAssetGlyph({
  ...
  // Raw SVG <image> bypasses Next's basePath handling — apply the
  // deployment prefix here so subpath deployments resolve the asset.
  const href = src.startsWith("/") ? withBasePath(src) : src;
  return (
    <svg
      width={size}
      height={size}
