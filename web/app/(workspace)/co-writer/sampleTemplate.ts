...
export const CO_WRITER_SAMPLE_TEMPLATE = `# DeepMentor Co-Writer

> DeepMentor's built-in writing canvas for notes, reports, tutorials, and AI-assisted drafts.
...
- A practical starter draft for DeepMentor product docs and learning content

## Headers (Underline)

DeepMentor Learning Note
=============

DeepMentor Study Outline
-------------
...
The <abbr title="Large Language Model">LLM</abbr> layer powers DeepMentor while the <abbr title="Retrieval Augmented Generation">RAG</abbr> layer provides grounded knowledge support.

### Blockquotes

> DeepMentor helps students turn questions into structured understanding.
>
> "Learn deeply, write clearly.", [DeepMentor](#deepmentor-co-writer)

### Links

[DeepMentor Co-Writer](#deepmentor-co-writer "co-writer section")

[DeepMentor Learning Note](#deepmentor-learning-note)

[DeepMentor Website](https://deepmentor.info)

[Reference link][deepmentor-doc]

[deepmentor-doc]: #deepmentor-learning-note

### Code Blocks

#### Inline code

\`deepmentor chat --once "Summarize this section"\`

#### Code Blocks (Indented style)

    from deepmentor.runtime.orchestrator import ChatOrchestrator
    orchestrator = ChatOrchestrator()
    print("DeepMentor is ready.")
...
> DeepMentor brand mark used inside the co-writer template.

### Lists

- DeepMentor Chat
- DeepMentor Co-Writer
- DeepMentor Research
...
- [x] Draft a DeepMentor product note
...
op=>operation: DeepMentor analyzes intent
...
DeepMentor->KnowledgeBase: Load context
Note right of DeepMentor: Collect memory\\nand relevant knowledge
DeepMentor-->Student: Return guided response
Student->>DeepMentor: Request rewrite in co-writer
${FENCE}
