...
from deepmentor.services.rag.factory import DEFAULT_PROVIDER
...
def register(app: typer.Typer) -> None:
    ...
    def kb_create(
        ...
        from deepmentor.knowledge.initializer import initialize_knowledge_base
    ...
    def kb_add(
        ...
        from deepmentor.knowledge.add_documents import add_documents
    ...
    def kb_search(
        ...
        try:
            ...
            if provider in {PAGEINDEX_PROVIDER, PAGEINDEX_OSS_PROVIDER}:
                from deepmentor.services.rag.pipelines.pageindex.reasoning import (
    ...
    def kb_sync(name: str = typer.Argument(..., help="KB name.")) -> None:
        ...
        from deepmentor.services.github_source.sync import sync_source as gh_sync
        from deepmentor.services.web_source.sync import sync_source as web_sync
