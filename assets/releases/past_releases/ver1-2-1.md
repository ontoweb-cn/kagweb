# DeepMentor v1.2.1 Release Notes
...
- **CLI** — `/regenerate` (alias `/retry`) inside the `deepmentor chat` REPL.
...
**Full Changelog**: https://github.com/HKUDS/DeepMentor/compare/v1.2.0...v1.2.1
