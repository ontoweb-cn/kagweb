# DeepMentor v1.4.12 Release Notes
...
DeepMentor offloads retrieval to it over HTTP — no local index is built. Each KB
...
`pip install 'deepmentor[parse-pymupdf4llm]'`; engines that need packages can now be
...
Drop-in from v1.4.11: `pip install -U deepmentor`; Docker users pull
`ghcr.io/hkuds/deepmentor:latest`. No migrations. Existing LlamaIndex knowledge bases
...
**Full Changelog**: https://github.com/HKUDS/DeepMentor/compare/v1.4.11...v1.4.12
