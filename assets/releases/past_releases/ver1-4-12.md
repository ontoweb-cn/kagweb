...
KAGWeb offloads retrieval to it over HTTP — no local index is built. Each KB
...
`pip install 'kagweb[parse-pymupdf4llm]'`; engines that need packages can now be
...
Drop-in from v1.4.11: `pip install -U kagweb`; Docker users pull
`ghcr.io/hkuds/kagweb:latest`. No migrations. Existing LlamaIndex knowledge bases
...
**Full Changelog**: https://github.com/HKUDS/KAGWeb/compare/v1.4.11...v1.4.12
