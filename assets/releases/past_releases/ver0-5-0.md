# DeepMentor v0.5.0 Release Notes

**Release Date:** 2026.01.15

We're thrilled to announce DeepMentor v0.5.0! This release delivers **unified service configuration**, **flexible RAG pipeline selection**, and **major UI/UX improvements** across multiple modules.
...
> [!TIP]
> **Call for Issues:** We welcome your feedback! If you encounter any bugs or have feature requests, please [open an issue](https://github.com/HKUDS/DeepMentor/issues)! If you would like to submit a PR, please check out our [Contributing Guide](https://github.com/HKUDS/DeepMentor/blob/main/CONTRIBUTING.md).
...
- Added `deepmentor/services/config/unified_config.py` — Centralized configuration manager
- Added `deepmentor/api/routers/config.py` — Unified REST API for all service configs
- Refactored web search to support multiple providers (`deepmentor/services/search/`)
...
- Factory pattern in `deepmentor/services/rag/factory.py` for pipeline management

### Question Generation

- Refactored `AgentCoordinator` with specialized agents
- New `RetrieveAgent`, `GenerateAgent`, `RelevanceAnalyzer` in `deepmentor/agents/question/agents/`
...
* feat(kb): allow selecting RAG provider during KB create/upload by @tusharkhatriofficial in https://github.com/HKUDS/DeepMentor/pull/129
* fix(docker): make Dockerfile portable by @scrrlt in https://github.com/HKUDS/DeepMentor/pull/128
* feat: pre-commit CI integration by @scrrlt in https://github.com/HKUDS/DeepMentor/pull/126
* feat: LlamaIndex pipeline implementation by @tusharkhatriofficial in https://github.com/HKUDS/DeepMentor/pull/98
* feat: web search providers (Tavily, Exa, Jina, Serper) by @Andres77872 in https://github.com/HKUDS/DeepMentor/pull/95
* feat: Azure OpenAI support enhancement by @scrrlt in https://github.com/HKUDS/DeepMentor/pull/87
* fix: modal vertical centering by @OlalalalaO in https://github.com/HKUDS/DeepMentor/pull/117
* work: LLM error framework by @scrrlt in https://github.com/HKUDS/DeepMentor/pull/118

## New Contributors

* @Andres77872 made their first contribution in https://github.com/HKUDS/DeepMentor/pull/95
* @OlalalalaO made their first contribution in https://github.com/HKUDS/DeepMentor/pull/117

**Full Changelog**: https://github.com/HKUDS/DeepMentor/compare/v0.4.1...v0.5.0
