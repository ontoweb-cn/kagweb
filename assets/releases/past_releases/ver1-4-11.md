# DeepMentor v1.4.11 Release Notes
...
[CONTAINERIZATION.md](https://github.com/HKUDS/DeepMentor/blob/main/CONTAINERIZATION.md).
...
Drop-in from v1.4.10: `pip install -U deepmentor`; Docker users pull
`ghcr.io/hkuds/deepmentor:latest`. No migrations, no configuration changes. The one
...
**Full Changelog**: https://github.com/HKUDS/DeepMentor/compare/v1.4.10...v1.4.11
