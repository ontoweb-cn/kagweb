...
[CONTAINERIZATION.md](https://github.com/HKUDS/KAGWeb/blob/main/CONTAINERIZATION.md).
...
Drop-in from v1.4.10: `pip install -U kagweb`; Docker users pull
`ghcr.io/hkuds/kagweb:latest`. No migrations, no configuration changes. The one
...
**Full Changelog**: https://github.com/HKUDS/KAGWeb/compare/v1.4.10...v1.4.11
