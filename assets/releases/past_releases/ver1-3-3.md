# DeepMentor v1.3.3 Release Notes
...
DeepMentor now covers more hosted provider setups out of the box and keeps the
...
- **Dependency resolution is less fragile** - the NumPy upper bound was relaxed
  to support current Manim installs in `deepmentor[all]`, and Windows setup docs
...
**Full Changelog**: https://github.com/HKUDS/DeepMentor/compare/v1.3.2...v1.3.3
