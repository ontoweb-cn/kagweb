...
multimodal image-fallback fix for providers KAGWeb has no vision entry for.
...
## Upgrade Notes
- Drop-in from v1.4.0: `pip install -U kagweb`; Docker users pull
...
**Full Changelog**: https://github.com/HKUDS/KAGWeb/compare/v1.4.0...v1.4.1
