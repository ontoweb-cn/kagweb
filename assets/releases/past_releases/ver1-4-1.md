# DeepMentor v1.4.1 Release Notes
...
multimodal image-fallback fix for providers DeepMentor has no vision entry for.
...
## Upgrade Notes
- Drop-in from v1.4.0: `pip install -U deepmentor`; Docker users pull
...
**Full Changelog**: https://github.com/HKUDS/DeepMentor/compare/v1.4.0...v1.4.1
