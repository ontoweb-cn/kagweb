...
[kagweb.info](https://kagweb.info/) have been rebuilt alongside —
...
[kagweb.info](https://kagweb.info/) was rebuilt with this release:
...
- `pip install -U kagweb` — the migrations run automatically on first
...
**Full Changelog**: https://github.com/HKUDS/KAGWeb/compare/v1.4.2...v1.4.3
