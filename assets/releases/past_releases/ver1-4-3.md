# DeepMentor v1.4.3 Release Notes
...
[deepmentor.info](https://deepmentor.info/) have been rebuilt alongside —
...
[deepmentor.info](https://deepmentor.info/) was rebuilt with this release:
...
- `pip install -U deepmentor` — the migrations run automatically on first
...
**Full Changelog**: https://github.com/HKUDS/DeepMentor/compare/v1.4.2...v1.4.3
