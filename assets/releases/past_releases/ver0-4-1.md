# 🔧 DeepMentor v0.4.1 Release Notes
...
**Removed `deepmentor/core` module** - All functionality migrated to `deepmentor/services`:

| Old Import | New Import |
|:---|:---|
| `from deepmentor.core.core import load_config_with_main` | `from deepmentor.services.config import load_config_with_main` |
| `from deepmentor.core.llm_factory import llm_complete` | `from deepmentor.services.llm import complete` |
| `from deepmentor.core.prompt_manager import get_prompt_manager` | `from deepmentor.services.prompt import get_prompt_manager` |
| `from deepmentor.core.logging import get_logger` | `from deepmentor.logging import get_logger` |
...
**Full Changelog**: https://github.com/HKUDS/DeepMentor/compare/v0.4.0...v0.4.1
