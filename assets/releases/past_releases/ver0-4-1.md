...
**Removed `kagweb/core` module** - All functionality migrated to `kagweb/services`:

| Old Import | New Import |
|:---|:---|
| `from kagweb.core.core import load_config_with_main` | `from kagweb.services.config import load_config_with_main` |
| `from kagweb.core.llm_factory import llm_complete` | `from kagweb.services.llm import complete` |
| `from kagweb.core.prompt_manager import get_prompt_manager` | `from kagweb.services.prompt import get_prompt_manager` |
| `from kagweb.core.logging import get_logger` | `from kagweb.logging import get_logger` |
...
**Full Changelog**: https://github.com/HKUDS/KAGWeb/compare/v0.4.0...v0.4.1
