...
session), and a Docs link to [kagweb.info](https://kagweb.info/)
...
- Drop-in from v1.4.1: `pip install -U kagweb`; Docker users pull
...
**Full Changelog**: https://github.com/HKUDS/KAGWeb/compare/v1.4.1...v1.4.2
