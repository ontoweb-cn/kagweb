# DeepMentor v1.5.1 Release Notes
...
Drop-in from v1.5.0: `pip install -U deepmentor`; Docker users pull `ghcr.io/hkuds/deepmentor:latest`. No migrations and no behavior changes — existing knowledge bases, partners, and mastery paths keep working as-is. Connected (read-only) and legacy knowledge bases still reject per-file deletion, as before.

**Full Changelog**: https://github.com/HKUDS/DeepMentor/compare/v1.5.0...v1.5.1
