...
Drop-in from v1.4.14: `pip install -U kagweb`; Docker users pull `ghcr.io/hkuds/kagweb:latest`. No migrations and no behavior changes — existing knowledge bases, partners, and mastery paths keep working as-is.

**Full Changelog**: https://github.com/HKUDS/KAGWeb/compare/v1.4.14...v1.4.15
