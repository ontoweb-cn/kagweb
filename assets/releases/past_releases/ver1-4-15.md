# DeepMentor v1.4.15 Release Notes
...
Drop-in from v1.4.14: `pip install -U deepmentor`; Docker users pull `ghcr.io/hkuds/deepmentor:latest`. No migrations and no behavior changes — existing knowledge bases, partners, and mastery paths keep working as-is.

**Full Changelog**: https://github.com/HKUDS/DeepMentor/compare/v1.4.14...v1.4.15
