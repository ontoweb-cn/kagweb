# KAGWeb v1.4.7 Release Notes

**Release Date:** 2026.06.18

A focused release on top of [v1.4.6](ver1-4-6.md): your local coding agents
become something KAGWeb can talk to. Connect **Claude Code** or **Codex**
...
> or Codex CLI already installed on the machine running KAGWeb — nothing is
...
- KAGWeb detects an installed **Claude Code** or **Codex** and connects it as
...
- Drop-in from v1.4.6: `pip install -U kagweb`; Docker users pull
  `ghcr.io/hkuds/kagweb:latest`. No migrations.
- Connected Agents require the Claude Code and/or Codex CLI installed on the
  host running KAGWeb — they are detected, never installed for you.
- The docs at [kagweb.info](https://kagweb.info/) are still catching up to
  the recent releases and will be refreshed shortly.

**Full Changelog**: https://github.com/HKUDS/KAGWeb/compare/v1.4.6...v1.4.7
