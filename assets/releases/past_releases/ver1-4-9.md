...
When KAGWeb grades a question inside a Mastery Path, the attempt — the
...
Drop-in from v1.4.8: `pip install -U kagweb`; Docker users pull
`ghcr.io/hkuds/kagweb:latest`. No migrations, no configuration changes.

**Full Changelog**: https://github.com/HKUDS/KAGWeb/compare/v1.4.8...v1.4.9
