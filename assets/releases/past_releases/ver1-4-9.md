# DeepMentor v1.4.9 Release Notes
...
When DeepMentor grades a question inside a Mastery Path, the attempt — the
...
Drop-in from v1.4.8: `pip install -U deepmentor`; Docker users pull
`ghcr.io/hkuds/deepmentor:latest`. No migrations, no configuration changes.

**Full Changelog**: https://github.com/HKUDS/DeepMentor/compare/v1.4.8...v1.4.9
