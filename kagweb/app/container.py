...
from kagweb.runtime.capability_catalog import get_capability_catalog
...
from kagweb.runtime.registry.capability_registry import CapabilityRegistry
from kagweb.runtime.turn_engine import TurnEngine
from kagweb.services.config import load_integrations_settings, load_system_settings
from kagweb.services.session import get_session_store
from kagweb.services.session.protocol import SessionStoreProtocol
from kagweb.services.session.scope import store_scope
...
class ApplicationContainer:
    ...
    async def recover_once(self) -> None:
        ...
        from kagweb.multi_user.paths import user_context
    ...
    def _local_users() -> list[Any]:
        ...
        from kagweb.multi_user.paths import local_admin_user, scope_for_user
    ...
    async def migrate_legacy_chat(self, *, dry_run: bool = False) -> dict[str, Any]:
        ...
        from kagweb.services.session.legacy_migration import (
    ...
    async def migrate_all_workspace_preferences(self) -> list[dict[str, Any]]:
        ...
        from kagweb.multi_user.identity import list_user_info
        from kagweb.multi_user.models import CurrentUser
        from kagweb.multi_user.paths import local_admin_user, scope_for_user, user_context
