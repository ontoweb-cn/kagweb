...
from kagweb.i18n.metadata_i18n import localized_description, tool_description_i18n
from kagweb.services.i18n import current_language
...
async def build_tool_options(
    *,
    ...
    """
    from kagweb.runtime.registry.deferred_tools import provider_identity
