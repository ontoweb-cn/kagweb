...
Why live here vs inside ``kagweb.partners.channels``?
...
from kagweb.services.partners.manager import _is_secret_field
...
def all_channel_schemas() -> dict[str, dict[str, Any]]:
    ...
    """
    from kagweb.partners.channels.registry import discover_all_with_errors
