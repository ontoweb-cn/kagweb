...
from kagweb.core.tool_protocol import BaseTool, ToolDefinition, ToolPromptHints
from kagweb.i18n.metadata_i18n import tool_description_i18n
from kagweb.services.config import resolve_search_runtime_config
from kagweb.services.settings.interface_settings import get_enabled_optional_tools
from kagweb.tools.builtin import (
    BUILTIN_TOOL_TYPES,
...
async def list_builtin_tools() -> ToolsListResponse:
    ...
    from kagweb.capabilities import capability_tool_owners
