...
from kagweb.multi_user.paths import current_owner_id
from kagweb.services.i18n import t
from kagweb.services.mcp import MCPServerConfig, get_mcp_manager, load_mcp_config, oauth
from kagweb.services.mcp.catalog import (
    build_server_config,
    category_counts,
    get_entry,
    search_catalog,
...
from kagweb.services.mcp.secrets import configured_fields, delete_secrets, store_secrets
...
def _extract_credentials(
    ...
    """
    from kagweb.services.mcp.secrets import SECRET_REFERENCE_RE, secret_reference
