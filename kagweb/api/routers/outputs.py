...
from kagweb.api.routers.auth import require_auth
from kagweb.multi_user.context import get_current_user_or_none
from kagweb.multi_user.paths import get_path_service_for_scope
...
async def read_output(
    ...
    return FileResponse(_resolve_output(_request_path_service(), output_path))
