...
from kagweb.partners.channels.weixin_qr import ILINK_APP_ID
from kagweb.partners.config.schema import DeliveryOverrides
from kagweb.partners.helpers import safe_filename, split_message
...
class WeixinChannel(BaseChannel):
    ...
    async def start(self) -> None:
        ...
        if not self._token:
            ...
            # KAGWeb (or auto-starting a Partner) must never take over the
    ...
    async def _send_text(
        ...
        client_id = f"kagweb-{uuid.uuid4().hex[:12]}"
