...
class KAGWebError(Exception):
    """Base class for all application errors in KAGWeb."""
...
class ConfigurationError(KAGWebError):
    """Raised when there's a configuration-related error."""

    pass


class ValidationError(KAGWebError):
    """Raised when input validation fails."""

    pass


class ServiceError(KAGWebError):
