"""Neutral plugin discovery for KAGWeb.

External packages register under the ``kagweb.plugins`` entry-point group.
...
ENTRY_POINT_GROUP = "kagweb.plugins"
...
def discover_plugins() -> list[PluginManifest]:
    """Discover plugins registered via ``kagweb.plugins`` entry points."""
