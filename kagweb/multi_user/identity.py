...
from kagweb.services.file_io import atomic_write_text
from kagweb.utils.secret_files import write_secret_text
...
# process FastAPI deployments (the ``kagweb start`` launcher) are fully covered;
...
def _env_bootstrap_admin() -> tuple[str, str]:
    ...
    :mod:`kagweb.services.auth` is imported lazily because it imports this
