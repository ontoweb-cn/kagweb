...
from kagweb.runtime.home import PACKAGE_ROOT, get_runtime_data_root
from kagweb.utils.secret_files import ensure_private_directory, write_secret_text
...
class PathService:
    ...
    def get_parse_cache_root(self) -> Path:
        ...
        ``(source_hash, parser_signature)`` — see ``kagweb/services/parsing``.
        """
...
def get_path_service() -> PathService:
    try:
        from kagweb.multi_user.paths import get_current_path_service
