...
from kagweb.multi_user.partner_access import can_use_partner
...
from kagweb.services.partner_groups.modes import DiscussionContext, discussion_mode_registry
