...
from kagweb.multi_user.paths import get_current_path_service, user_context
from kagweb.partners.bus.events import InboundMessage, OutboundMessage
from kagweb.partners.bus.queue import MessageBus
from kagweb.partners.helpers import detect_image_mime
from kagweb.services.partners.commands import PartnerCommandHandler
from kagweb.services.partners.interaction import (
    actor_for_account,
...
from kagweb.services.partners.links import linked_user_id
from kagweb.services.partners.scope import partner_user
from kagweb.services.partners.sessions import PartnerSessionStore
from kagweb.services.partners.workspace import ensure_partner_workspace, read_soul
...
class PartnerRunner:
    ...
    def _identify(self, msg: InboundMessage) -> None:
        """Attach the sender's KAGWeb identity to a channel message, if any.
    ...
    async def _execute_turn(
        ...
        *,
        ...
        """
        from kagweb.runtime.turn_engine import get_turn_engine
    ...
    def _build_context(
        ...
        *,
        ...
        metadata: dict[str, Any] = {
            ...
            # Swaps the system prompt's product identity ("You are KAGWeb")
