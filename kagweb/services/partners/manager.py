...
Each partner runs as a set of asyncio tasks within the KAGWeb server
...
from kagweb.multi_user.models import CurrentUser
from kagweb.partners.config.paths import (
    get_data_dir,
    get_partner_dir,
    get_partner_sessions_dir,
)
from kagweb.services.partners.interaction import forget_partner_stores
from kagweb.services.partners.links import forget_partner_links
...
class PartnerManager:
    ...
    async def _outbound_router(self, partner_id: str, bus: Any, instance: PartnerInstance) -> None:
        ...
        try:
            ...
            from kagweb.partners.bus.events import OutboundMessage as _OMsg
    ...
    async def send_group_message(
        ...
        *,
        ...
        from kagweb.partners.bus.events import InboundMessage
        from kagweb.services.partners.runtime import PartnerTurnOptions
    ...
    def _rehome_shared_channel_state(self) -> None:
        ...
        try:
            from kagweb.services.partners.channel_state_migration import (
