...
from kagweb.runtime.isolated_worker import IsolatedWorkerError, run_in_isolated_process_sync
from kagweb.utils.document_extractor import SUPPORTED_DOC_EXTENSIONS
from kagweb.utils.document_validator import DocumentValidator
        ...
        *,
        ...
        try:
            run_in_isolated_process_sync(
                "kagweb.runtime.worker_tasks:extract_document_to_markdown",
                str(source_path),
                str(output_path),
                kwargs={
