...
stage. An engine turns bytes/path into a :class:`~kagweb.services.parsing.types.ParsedDocument`
...
class Parser(Protocol):
    ...
    def parse(
        ...
        *,
        ...
        workdir via :func:`kagweb.services.parsing.cache.load_ir` and writes
