...
:class:`~kagweb.services.mcp.config.MCPServerConfig`, the only server shape
the rest of KAGWeb understands.
...
:mod:`kagweb.services.mcp.secrets` resolves in memory at connect time. That
...
from kagweb.services.mcp.secrets import secret_reference
