...
Unified configuration loading for all KAGWeb modules.
...
def parse_language(language: Any) -> str:
    ...
    from kagweb.services.prompt.language import normalize_language
...
def get_agent_params(module_name: str) -> dict:
    ...
    from kagweb.services.setup.init import DEFAULT_AGENTS_SETTINGS
