"""Local and opt-in online diagnostics for the KAGWeb CLI."""
...
from kagweb.services.llm.utils import is_local_llm_server, sanitize_url
...
class DoctorCheck:
    """One diagnostic result shown by ``kagweb doctor``."""
...
async def run_diagnostics(
    *,
    ...
    if resolve_llm is None:
        from kagweb.services.config import resolve_llm_runtime_config
