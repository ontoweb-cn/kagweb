...
from kagweb.services.llm.capabilities import disable_response_format_at_runtime
from kagweb.services.llm.exceptions import LLMConfigError
from kagweb.services.llm.openai_http_client import openai_sdk_client_kwargs
...
from kagweb.services.llm.request_compat import is_response_format_unsupported
from kagweb.services.llm.usage_frame import token_counts
from kagweb.services.provider_registry import model_overrides_for, normalize_wire_api
    ...
    def _sanitize_messages(
        ...
        *,
        ...
        if responses_api:
            ...
            # a protocol identity. The converter splits KAGWeb's compound
