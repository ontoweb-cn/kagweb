...
from kagweb.core.capability_protocol import TurnCapability
from kagweb.core.entry_points import load_entry_point_group
from kagweb.i18n.metadata_i18n import capability_description_i18n
from kagweb.runtime.bootstrap.builtin_capabilities import BUILTIN_CAPABILITY_SPECS
from kagweb.runtime.capability_catalog import (
    CapabilityCatalog,
    EmptyConfig,
    get_capability_catalog,
)
from kagweb.runtime.request_contracts import CAPABILITY_CONFIG_MODELS

logger = logging.getLogger(__name__)

EXTENSIONS_GROUP = "kagweb.extensions"
LEGACY_PLUGINS_GROUP = "kagweb.plugins"
...
class CapabilityRegistry:
    ...
    def load_plugins(self) -> None:
        ...
        try:
            module = importlib.import_module("kagweb.plugins.loader")
