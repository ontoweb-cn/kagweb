...
Two things the process-global :class:`~kagweb.runtime.registry.tool_registry.ToolRegistry`
...
class ScopedToolRegistry:
    ...
    Satisfies :class:`~kagweb.core.tool_protocol.ToolLookup`. Intentionally
