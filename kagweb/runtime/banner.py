"""Branded banner + localized labels for ``kagweb start`` / ``kagweb init``.
...
LABELS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "init.next_step": "Run `kagweb start` to launch KAGWeb.",
        "init.choice": "Choice",
        ...
        "start.detached_started": "KAGWeb is starting in the background (launcher PID {pid}).",
        "start.detached_already_running": (
            "A detached KAGWeb launcher is already running (PID {pid}). Log: {log}"
        ),
        "start.detached_log": "Log: {path}",
        "start.detached_stop_hint": 'Stop it with `kagweb stop --home "{home}"`.',
        ...
        "start.frontend_restart_failed": (
            ...
            "Stop PID {pid} and run `kagweb start` again."
        ),
        ...
        "stop.not_running": "No detached KAGWeb launcher is running.",
    ...
    "zh": {
        ...
        "init.next_step": "运行 `kagweb start` 启动 KAGWeb。",
        "init.choice": "请选择",
        ...
        "start.detached_started": "KAGWeb 正在后台启动（launcher PID {pid}）。",
        "start.detached_already_running": (
            "已有后台 KAGWeb launcher 正在运行（PID {pid}）。日志：{log}"
        ),
        "start.detached_log": "日志：{path}",
        "start.detached_stop_hint": '运行 `kagweb stop --home "{home}"` 停止。',
        ...
        "start.frontend_restart_failed": (
            ...
            "请先停止 PID {pid},然后重新运行 `kagweb start`。"
        ),
        ...
        "stop.not_running": "当前没有后台 KAGWeb launcher 在运行。",
