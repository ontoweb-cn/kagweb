...
from kagweb.utils.secret_files import ensure_private_directory, ensure_private_file
...
def configure_logging(force: bool = False) -> LoggingConfig:
    ...
    logging.getLogger("kagweb").setLevel(logging.DEBUG)
    logging.getLogger("kagweb").propagate = True
