...
from kagweb.tools.builtin_specs import (
    BUILTIN_TOOL_NAMES,
    BUILTIN_TOOL_SPECS,
...
from kagweb.tools.prompting import load_prompt_hints
...
class BrainstormTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from kagweb.tools.brainstorm import brainstorm
...
class WebSearchTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from kagweb.tools.web_search import web_search
...
class ReasonTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from kagweb.tools.reason import reason
...
class PaperSearchToolWrapper(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from kagweb.tools.paper_search_tool import ArxivSearchTool
