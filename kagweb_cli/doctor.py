"""Setup diagnostics for the KAGWeb CLI."""
...
from kagweb.services.doctor import (
    DoctorReport,
    run_diagnostics,
...
def _render_rich(report: DoctorReport) -> None:
    table = Table(title="KAGWeb setup diagnostics")
...
def register(app: typer.Typer) -> None:
    ...
    def doctor(
        ...
        """Check whether KAGWeb is ready to start a session."""
