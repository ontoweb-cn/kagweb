...
from deepmentor.api.utils.task_log_stream import (
...
def test_capture_task_logs_keeps_user_stages_and_drops_runtime_noise():
    ...
    loggers = {
        ...
        for name in (
            "root",
            "asyncio",
            "deepmentor.knowledge.progress_tracker",
            "deepmentor.services.rag.pipelines.pageindex.pipeline",
        )
    }
    ...
    try:
        ...
        with capture_task_logs("task-curated"):
            ...
            loggers["deepmentor.knowledge.progress_tracker"].info("duplicate progress")
            loggers["deepmentor.services.rag.pipelines.pageindex.pipeline"].info(
