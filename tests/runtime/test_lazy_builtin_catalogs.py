...
from deepmentor.tools.builtin_specs import BUILTIN_TOOL_SPECS
...
import deepmentor.capabilities.registry
import deepmentor.runtime.registry.capability_registry
import deepmentor.runtime.registry.tool_registry

forbidden = (
    "deepmentor.agents.chat.agentic_pipeline",
    "deepmentor.capabilities.solve.loop",
    "deepmentor.capabilities.mastery.loop",
    "deepmentor.visualizers.loop_capability",
)
