...
from deepmentor.reading.vocabulary import VocabularyExtension
...
async def test_vocabulary_returns_a_bounded_card(monkeypatch):
    ...
    monkeypatch.setattr("deepmentor.reading.vocabulary.complete", complete)
...
def test_vocabulary_is_registered_as_a_packaged_extension():
    ...
    assert group["vocabulary"] == "deepmentor.reading.vocabulary:VocabularyExtension"
