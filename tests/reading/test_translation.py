...
from deepmentor.reading.translation import TranslationExtension
...
async def test_translation_returns_a_bounded_card(monkeypatch):
    ...
    monkeypatch.setattr("deepmentor.reading.translation.complete", complete)
...
def test_translation_is_registered_as_a_packaged_extension():
    ...
    assert group["translation"] == "deepmentor.reading.translation:TranslationExtension"
