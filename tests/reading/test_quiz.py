...
from deepmentor.reading.quiz import ReadingQuizExtension
...
async def test_quiz_returns_a_bounded_quiz_without_grounding_metadata(monkeypatch):
    ...
    monkeypatch.setattr("deepmentor.reading.quiz.complete", complete)
...
def test_quiz_is_registered_as_a_packaged_extension():
    ...
    assert group["quiz"] == "deepmentor.reading.quiz:ReadingQuizExtension"
