...
def _load_question_extractor_module():
    ...
    stubbed_modules = {
        "deepmentor.services.config": {"get_agent_params": lambda *_args, **_kwargs: {}},
        "deepmentor.services.llm": {"complete": lambda *_args, **_kwargs: None},
        "deepmentor.services.llm.capabilities": {
            "supports_response_format": lambda *_args, **_kwargs: False
        },
        "deepmentor.services.llm.config": {"get_llm_config": lambda: None},
        "deepmentor.utils.json_parser": {"parse_json_response": lambda *_args, **_kwargs: {}},
    }
