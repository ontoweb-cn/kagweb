...
from deepmentor.services.memory.recall import RecallHit
...
def isolated_scope(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> Path:
    ...
    """
    import deepmentor.services.path_service as path_service
...
def test_l3_renders_sections_and_bullets(monkeypatch: pytest.MonkeyPatch) -> None:
    import deepmentor.services.memory as memory
