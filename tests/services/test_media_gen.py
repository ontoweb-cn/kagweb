...
from deepmentor.services.generation_http import (
    GenerationProviderError,
    build_auth_headers,
    join_api_path,
)
from deepmentor.services.imagegen import generate_image
from deepmentor.services.imagegen.adapters.chat_completions import ChatCompletionsImagegenAdapter
from deepmentor.services.imagegen.adapters.dashscope import DashScopeImagegenAdapter
from deepmentor.services.imagegen.adapters.openai_compat import OpenAICompatImagegenAdapter
from deepmentor.services.imagegen.config import ImagegenConfig
from deepmentor.services.videogen import generate_video, probe_video
...
async def test_imagegen_tool_saves_public_artifact(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    import deepmentor.services.imagegen as imagegen_mod
    from deepmentor.services.path_service import get_path_service
    from deepmentor.tools.media_gen_tool import ImagegenTool
...
async def test_videogen_tool_forwards_progress_and_saves(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    from deepmentor.services.path_service import get_path_service
    import deepmentor.services.videogen as videogen_mod
    from deepmentor.tools.media_gen_tool import VideogenTool
