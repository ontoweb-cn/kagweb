...
from deepmentor.services.rag.index_versioning import EmbeddingSignature
...
async def test_incremental_add_migrates_matching_legacy_index_to_flat_version(
    ...
    from deepmentor.services.rag.pipelines.llamaindex import storage as storage_module
...
def test_retrieval_config_reads_profile_from_env(monkeypatch: pytest.MonkeyPatch) -> None:
    from deepmentor.services.rag.pipelines.llamaindex import config as config_module

    monkeypatch.setenv("DEEPMENTOR_RAG_RETRIEVAL_PROFILE", " vector ")
