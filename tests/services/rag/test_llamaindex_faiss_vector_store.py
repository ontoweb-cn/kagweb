...
from deepmentor.services.rag.pipelines.llamaindex import vector_store
from deepmentor.services.rag.pipelines.llamaindex.config import VectorIndexConfig
...
def _multimodal_nodes() -> list[object]:
    ...
    DeepMentor embeds text and images with the *same* embedding client, so both
...
def test_storage_create_index_honors_hnsw_settings(
    ...
    from deepmentor.services.rag.pipelines.llamaindex import ingestion
