...
def test_progress_disabled_when_stdout_is_not_a_tty(monkeypatch) -> None:
    ...
    When DeepMentor runs as a server, stdout is a pipe whose read end can
    ...
    """
    from deepmentor.services.rag.pipelines.llamaindex.config import should_show_progress
