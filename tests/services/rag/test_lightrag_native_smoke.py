...
from deepmentor.services.rag.pipelines.lightrag import engine, ingress, storage
...
def test_real_rc2_raw_bridge_reaches_processed(monkeypatch, tmp_path: Path) -> None:
    ...
    source.write_text("DeepMentor native LightRAG fixture.", encoding="utf-8")
    staged = ingress.freeze_document(
        working,
        source,
        ParsedDocument(
            markdown="# Native fixture\n\nDeepMentor uses LightRAG.",
            engine="text_only",
    ...
    staged = ingress.freeze_document(
        ...
        ParsedDocument(
            ...
            blocks=[
                ...
                {"type": "text", "text": "DeepMentor structured body.", "page_idx": 0},
                {
                    "type": "table",
