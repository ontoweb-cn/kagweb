...
def test_loader_routes_parser_files_through_active_parse_engine(
    ...
    from deepmentor.services.rag.pipelines.llamaindex.document_loader import (
...
def test_loader_explains_scanned_pdf_when_parser_yields_images_only(
    ...
    pytest.importorskip("llama_index.core")
    from deepmentor.services.parsing.types import ParsedDocument
    from deepmentor.services.rag.pipelines.llamaindex import document_loader as loader_module
    from deepmentor.services.rag.pipelines.llamaindex.document_loader import (
        LlamaIndexDocumentLoader,
    )
