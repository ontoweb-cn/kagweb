...
from deepmentor.services.rag.pipelines.graphrag import storage as graphrag_storage
from deepmentor.services.rag.pipelines.pageindex import storage as pageindex_storage
...
def test_llamaindex_doc_count_cached_until_file_changes(
    ...
    from deepmentor.services.rag.index_probe import _read_json
    ...
    monkeypatch.setattr("deepmentor.services.rag.index_probe._read_json", counting_read)
