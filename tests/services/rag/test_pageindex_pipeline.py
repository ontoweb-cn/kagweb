...
from deepmentor.services.rag.factory import get_pipeline, normalize_provider_name
from deepmentor.services.rag.index_versioning import resolve_storage_dir_for_read
from deepmentor.services.rag.pipelines.pageindex import client as client_mod
from deepmentor.services.rag.pipelines.pageindex import storage
from deepmentor.services.rag.pipelines.pageindex.client import PageIndexClient
from deepmentor.services.rag.pipelines.pageindex.config import PageIndexConfig
...
def test_factory_dispatches_by_provider(tmp_path, monkeypatch) -> None:
    ...
    from deepmentor.services.rag.pipelines.llamaindex.pipeline import LlamaIndexPipeline
...
def test_pageindex_ready_omits_embedding_identity(tmp_path, monkeypatch) -> None:
    import deepmentor.knowledge.manager as manager_module
    from deepmentor.knowledge.manager import KnowledgeBaseManager
    from deepmentor.services.rag import embedding_signature as signature_module
