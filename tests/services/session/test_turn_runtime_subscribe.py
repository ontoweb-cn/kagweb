...
from deepmentor.services.courses import CourseService
...
async def test_start_turn_persists_requested_course(
    ...
    monkeypatch.setattr("deepmentor.services.courses.get_course_service", lambda: course_service)
...
async def test_reconnect_after_turn_completion_still_carries_message_ids(
    ...
    monkeypatch.setattr(
        "deepmentor.services.session.context_builder.ContextBuilder",
        FakeContextBuilder,
    )
