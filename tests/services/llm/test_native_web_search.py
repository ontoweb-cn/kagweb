...
* ``convert_tools`` — DeepMentor's ``web_search`` function tool declared as the
...
from deepmentor.runtime.agentic import client as client_module
from deepmentor.runtime.agentic.client import LLMClientConfig
