...
from deepmentor.services.llm.openai_http_client import sanitize_invalid_ssl_env
...
def test_build_openai_client_survives_stale_ssl_cert_file(
    ...
    from deepmentor.runtime.agentic.client import LLMClientConfig, build_openai_client
