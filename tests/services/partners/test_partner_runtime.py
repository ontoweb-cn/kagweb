...
class TestTurnExecution:
    ...
    async def test_group_collaboration_publishes_saved_formal_answer_not_decision_ack(
        ...
        import deepmentor.runtime.orchestrator as orchestrator_module
...
class TestContextAssembly:
    ...
    async def test_context_carries_soul_tools_and_metadata(self, partners_root, fake_orchestrator):
        from deepmentor.services.partners.workspace import write_soul
...
class TestBuiltinToolsAndMemory:
    ...
    async def test_turn_runs_against_partner_memory(self, partners_root, fake_orchestrator):
        ...
        from deepmentor.partners.config.paths import get_partner_workspace
    ...
    async def test_authenticated_users_get_isolated_session_history(
        ...
        from deepmentor.multi_user.models import CurrentUser
        from deepmentor.multi_user.paths import scope_for_user
        from deepmentor.partners.config.paths import get_partner_user_sessions_dir
...
class TestLiveTurn:
    def test_channel_activity_feed_broadcasts_replays_and_isolates_accounts(self):
        from deepmentor.services.partners.manager import PartnerActivityFeed
    ...
    def test_owner_activity_history_can_merge_private_and_unlinked_channel_sessions(
        ...
        from deepmentor.multi_user.models import CurrentUser
        from deepmentor.multi_user.paths import scope_for_user, user_context
    ...
    async def test_group_boundary_returns_trace_and_invocation_metadata(
        ...
        from deepmentor.capabilities.partner_group import PartnerGroupCapability
        from deepmentor.capabilities.partner_group.tools import InvokeOtherTool
        import deepmentor.runtime.orchestrator as orchestrator_module
        from deepmentor.services.partners.manager import PartnerManager
    ...
    def test_buffer_replays_for_late_subscriber(self):
        from deepmentor.services.partners.manager import LiveTurn
...
class TestPartnerCommands:
    ...
    async def test_sessions_resume_delete_commands(self, partners_root, fake_orchestrator):
        from deepmentor.services.partners.commands import PartnerCommandHandler
    ...
    async def test_telegram_bot_command_suffix_is_supported(self, partners_root, fake_orchestrator):
        ...
        reply = await runner.process_message(_msg("/new@DeepMentorBot"))
