...
from deepmentor.services.llm.config import clear_llm_config_cache, get_llm_config
...
def test_starter_generation_calls_the_task_model(
    ...
    from deepmentor.services import suggestions
    import deepmentor.services.llm as llm
...
def _run_title(monkeypatch: pytest.MonkeyPatch, observed: list[str]) -> _Runtime:
    import deepmentor.services.llm as llm
    from deepmentor.services.session import turn_runtime as turn_runtime_module
...
def test_title_generation_inherits_the_turn_model_when_unconfigured(
    ...
    from deepmentor.services.llm.config import (
        LLMConfig,
