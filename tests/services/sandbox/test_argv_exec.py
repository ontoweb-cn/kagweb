...
from deepmentor.services.sandbox.runner import server as runner_server
from deepmentor.services.sandbox.spec import ExecRequest
...
def test_the_sidecar_sends_both_spellings() -> None:
    ...
    import deepmentor.services.sandbox.backends as backends_module
