...
def _client(mu_isolated_root, monkeypatch) -> tuple[TestClient, dict]:
    ...
    from deepmentor.book import engine as engine_module
    from deepmentor.book import storage as storage_module
    from deepmentor.book.models import Book
    from deepmentor.book.storage import BookStorage
    from deepmentor.multi_user.identity import save_user
    from deepmentor.multi_user.paths import get_admin_path_service
    from deepmentor.services.auth import TokenPayload, hash_password
...
def test_guardian_can_assign_only_read_access_to_approved_books(mu_isolated_root, monkeypatch):
    ...
    from deepmentor.multi_user.book_permission import BookPermission
    from deepmentor.multi_user.identity import set_book_permission
...
def test_guardian_can_adjust_only_the_exposed_learning_restrictions(mu_isolated_root, monkeypatch):
    ...
    from deepmentor.multi_user.grants import load_grant
...
def test_guardian_can_reset_local_credentials_without_returning_or_auditing_secret(
    ...
    from deepmentor.services.auth import verify_password
...
def test_guardian_access_rechecks_the_current_account_presets(mu_isolated_root, monkeypatch):
    ...
    from deepmentor.multi_user.identity import set_preset
