...
from deepmentor.book.compiler import systemic_failure_reason
from deepmentor.book.engine import (
...
async def test_compile_is_rejected_while_book_is_paused() -> None:
    ...
    from deepmentor.book.engine import BookPausedError
...
def test_book_ids_cannot_escape_the_workspace() -> None:
    ...
    from deepmentor.book.storage import _safe_book_id
