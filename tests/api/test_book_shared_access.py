...
from deepmentor.api.routers import book as book_router
from deepmentor.book.models import Block, BlockStatus, BlockType, Book, Page, PageStatus
...
def shared_env(tmp_path, monkeypatch):
    ...
    from deepmentor.multi_user import audit, grants, identity, paths
    from deepmentor.multi_user.identity import save_user, set_book_permission
