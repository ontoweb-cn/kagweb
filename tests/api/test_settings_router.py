...
from deepmentor.services.embedding import client as embedding_client_module
from deepmentor.services.embedding import config as embedding_config_module
from deepmentor.services.llm import client as llm_client_module
from deepmentor.services.llm import config as llm_config_module
...
async def test_network_settings_roundtrip_normalizes_cors_origins(
    ...
    payload = settings_router.NetworkSettingsUpdate(
        backend_port=8101,
        frontend_port=3882,
        public_api_base="https://api.example.com/deepmentor",
    ...
    assert response["settings"]["public_api_base"] == "https://api.example.com/deepmentor"
...
async def test_fetch_models_returns_picker_options(monkeypatch: pytest.MonkeyPatch) -> None:
    import deepmentor.services.llm.factory as factory_module
