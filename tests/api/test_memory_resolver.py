...
memory_router = importlib.import_module("deepmentor.api.routers.memory").router
paths_mod = importlib.import_module("deepmentor.services.memory.paths")
document_mod = importlib.import_module("deepmentor.services.memory.document")
