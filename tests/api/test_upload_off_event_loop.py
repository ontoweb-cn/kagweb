...
from deepmentor.api.routers import knowledge as knowledge_router
from deepmentor.knowledge.add_documents import DocumentAdder
...
def test_recording_an_indexed_file_hash_runs_on_a_worker_thread(
    ...
    monkeypatch.setattr("deepmentor.knowledge.add_documents.RAGService", _OkRagService)
