...
import deepmentor.services.config as _dt_config
...
from deepmentor.api.routers import co_writer as co_writer_router
from deepmentor.api.routers.co_writer import _validate_doc_id
from deepmentor.co_writer import edit_agent
from deepmentor.co_writer.docx_converter import (
    DocxConversionError,
    docx_to_markdown,
    markdown_to_docx,
)
from deepmentor.co_writer.storage import CoWriterStorage
...
def test_docx_to_markdown_rejects_suspicious_zip(monkeypatch):
    monkeypatch.setattr("deepmentor.co_writer.docx_converter._DOCX_MAX_MEMBERS", 2)
    buf = BytesIO()
...
def test_importing_the_api_does_not_pull_python_docx_into_memory():
    ...
    probe = "import sys;import deepmentor.co_writer.docx_converter;print('docx' in sys.modules)"
