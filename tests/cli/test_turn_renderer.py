...
The chat agent loop (deepmentor/agents/chat/agent_loop.py) streams every
...
from deepmentor.app import TurnRequest
from deepmentor_cli import common as cli_common
from deepmentor_cli.common import _resolve_answer
...
def _install_fake_runtime(
    ...
    *,
    ...
    monkeypatch.setattr("deepmentor.app.facade.DeepMentorApp.submit_user_reply", _submit_user_reply)
