"""CLI smoke tests for ``deepmentor notebook`` commands."""
...
def _patch_facade(monkeypatch) -> None:
    """Patch DeepMentorApp methods to use the shared fake manager."""
    ...
    from deepmentor.app import facade

    monkeypatch.setattr(facade.DeepMentorApp, "create_notebook", _create_notebook)
    monkeypatch.setattr(facade.DeepMentorApp, "get_notebook", _get_notebook)
    monkeypatch.setattr(facade.DeepMentorApp, "add_record", _add_record)
    monkeypatch.setattr(facade.DeepMentorApp, "update_record", _update_record)
    monkeypatch.setattr(facade.DeepMentorApp, "remove_record", _remove_record)
