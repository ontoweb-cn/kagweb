"""Tests for the ``deepmentor doctor`` command."""
...
from deepmentor.services.doctor import (
    DoctorCheck,
    DoctorReport,
    _rag_check,
    run_diagnostics,
...
def test_doctor_json_exits_nonzero_for_required_failure(monkeypatch) -> None:
    ...
    monkeypatch.setattr("deepmentor_cli.doctor.run_diagnostics", fake_run_diagnostics)
