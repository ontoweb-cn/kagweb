...
from deepmentor.agents.chat import agent_loop as agent_loop_mod
from deepmentor.agents.chat.agent_loop import InlineThinkFilter
from deepmentor.agents.chat.agentic_pipeline import AgenticChatPipeline
from deepmentor.capabilities.explore_context import explorer as explorer_mod
from deepmentor.capabilities.mastery import MASTERY_TOOL_NAMES
...
from deepmentor.core.tool_protocol import ToolResult
from deepmentor.runtime.stream_bus import StreamBus
from deepmentor.services.llm import LLMProviderTransportError
...
def test_compose_enabled_tools_injects_rag_when_kb_selected(
    ...
    monkeypatch.setattr(
        "deepmentor.services.notebook.get_notebook_manager",
