...
from deepmentor.capabilities.mastery.capability import MasteryPathCapability
from deepmentor.capabilities.mastery.loop import MasteryLoopCapability
...
async def test_mastery_sync_carries_provenance_to_question_bank(tmp_path, monkeypatch) -> None:
    from deepmentor.capabilities.mastery.tools import (
...
async def test_status_on_unknown_path_creates_nothing(tmp_path, monkeypatch):
    ...
    """
    from deepmentor.capabilities.mastery.tools import MasteryStatusTool
...
async def test_a_switch_and_a_build_in_one_round_land_on_the_switched_path(tmp_path, monkeypatch):
    ...
    """
    from deepmentor.runtime.agentic.tool_dispatch import dispatch_tool_calls
