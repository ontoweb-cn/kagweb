...
from deepmentor.capabilities.course_study import CourseStudyLoopCapability
from deepmentor.capabilities.course_study.capability import COURSE_ID_KEY
...
def _stub_llm_config(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    """
    import deepmentor.agents.chat.agentic_pipeline as pipeline_module
