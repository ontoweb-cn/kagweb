...
from deepmentor.capabilities import any_exclusive_capability_active
from deepmentor.capabilities.ima import IMA_TOOL_NAMES, ImaCapability
from deepmentor.capabilities.ima import binding as ima_binding
from deepmentor.capabilities.ima import tools as ima_tools
from deepmentor.capabilities.ima.binding import ImaBinding, select_binding
from deepmentor.capabilities.ima.tools import (
    BINDINGS_KWARG,
    ImaAddUrlTool,
    ImaListTool,
    ImaNoteSearchTool,
...
from deepmentor.services.rag.pipelines.ima.config import ImaNotConfiguredError
from deepmentor.services.rag.pipelines.ima.envelope import ImaAuthError
from deepmentor.services.rag.pipelines.ima.media import ImaMediaContent
from deepmentor.services.rag.pipelines.ima.models import (
    ImaDocument,
    ImaFolder,
    ImaImportedUrl,
    ImaKnowledgePage,
...
class TestBinding:
    def test_only_ima_knowledge_bases_bind(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.setattr(
            "deepmentor.multi_user.knowledge_access.resolve_kb_metadata",
            metadata.get,
            raising=False,
        )
    ...
    def test_resolution_is_cached_on_the_turn(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.setattr(
            "deepmentor.multi_user.knowledge_access.resolve_kb_metadata", resolve, raising=False
        )
