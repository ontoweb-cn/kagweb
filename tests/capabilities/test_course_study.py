...
import deepmentor.capabilities.course_study as course_study_package
from deepmentor.capabilities.course_study import (
...
from deepmentor.capabilities.course_study.capability import summarize_course_state
from deepmentor.capabilities.course_study.mode import CourseStudyCapability
...
async def test_mode_injects_no_course_prompt_without_mounting_loop(
    ...
    import deepmentor.capabilities.course_study.mode as mode_module
...
async def test_pre_loop_summary_is_bounded_and_omits_full_detail(
    ...
    from deepmentor.services import courses_state
...
def test_reading_position_fallback_uses_latest_attached_workspace(
    ...
    from deepmentor import reading
    import deepmentor.capabilities.course_study.capability as capability_module
...
async def test_course_overview_happy_path_and_missing_binding(
    ...
    import deepmentor.capabilities.course_study.tools as tools_module
...
async def test_course_edit_forwards_all_actions_and_rejects_bad_input(
    ...
    import deepmentor.capabilities.course_study.tools as tools_module
    from deepmentor.services import courses
...
def test_course_defaults_fill_absent_fields_and_preserve_explicit_choices() -> None:
    from deepmentor.services.session.turn_runtime import _apply_course_defaults
