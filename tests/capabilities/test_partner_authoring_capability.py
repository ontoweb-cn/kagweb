...
from deepmentor.capabilities.partner_authoring import PartnerAuthoringCapability
from deepmentor.capabilities.partner_authoring.binding import is_partner_authoring_turn
from deepmentor.capabilities.partner_authoring.tools import ProposePartnerTool
