...
from deepmentor.runtime.agentic.client import LLMClientConfig, can_use_native_tool_calling
...
def test_custom_endpoint_in_anthropic_format_routes_through_anthropic_adapter(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "deepmentor.services.llm.provider_core.AnthropicProvider", FakeAnthropicProvider
    )
