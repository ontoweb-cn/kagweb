...
AGENTS_DIR = PROJECT_ROOT / "deepmentor" / "agents"
# Modules that live outside deepmentor/agents/ but still own prompts.
EXTRA_PROMPT_MODULE_DIRS = (
    PROJECT_ROOT / "deepmentor" / "book",
    PROJECT_ROOT / "deepmentor" / "co_writer",
)
