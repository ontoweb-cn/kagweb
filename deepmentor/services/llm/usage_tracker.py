...
class UsageTracker:
    ...
    * :meth:`add_estimated` — fall back to a coarse ``chars / 3.5`` estimate
    ...
    ``total_cost_usd`` via the pricing table in ``deepmentor.logging.stats``.
    """
    ...
    def add_usage(
        ...
        *,
        ...
        """Adapter for :class:`~deepmentor.agents.base_agent.BaseAgent`.
    ...
    def summary(self) -> dict[str, Any] | None:
        ...
        if self.model:
            ...
            from deepmentor.logging.stats.llm_stats import get_pricing
