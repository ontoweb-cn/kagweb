...
Usage:
    from deepmentor.services.llm.capabilities import get_capability, supports_response_format
...
MODEL_OVERRIDES: dict[str, dict[str, object]] = {
    ...
    # See: https://github.com/HKUDS/DeepMentor/issues/141
    "gpt-5": {
...
def threads_session_id(binding: str | None) -> bool:
    """Whether *binding* expects ``deepmentor_session_id`` on each request."""
