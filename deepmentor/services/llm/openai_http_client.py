...
if TYPE_CHECKING:
    from deepmentor.services.provider_registry import ProviderSpec
...
OPENROUTER_ATTRIBUTION_HEADERS: dict[str, str] = {
    "HTTP-Referer": "https://github.com/HKUDS/DeepMentor",
    "X-OpenRouter-Title": "DeepMentor",
}
...
def openai_sdk_client_kwargs(
    *,
    ...
    The one place that decides what every OpenAI-SDK client DeepMentor builds
