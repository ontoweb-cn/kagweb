...
from deepmentor.services.llm.capabilities import disable_response_format_at_runtime
from deepmentor.services.llm.exceptions import LLMConfigError
from deepmentor.services.llm.openai_http_client import openai_sdk_client_kwargs
...
from deepmentor.services.llm.request_compat import is_response_format_unsupported
from deepmentor.services.llm.usage_frame import token_counts
from deepmentor.services.provider_registry import model_overrides_for, normalize_wire_api
    ...
    def _sanitize_messages(
        ...
        *,
        ...
        if responses_api:
            ...
            # a protocol identity. The converter splits DeepMentor's compound
