...
Unified configuration loading for all DeepMentor modules.
...
def parse_language(language: Any) -> str:
    ...
    from deepmentor.services.prompt.language import normalize_language
...
def get_agent_params(module_name: str) -> dict:
    ...
    from deepmentor.services.setup.init import DEFAULT_AGENTS_SETTINGS
