"""Local and opt-in online diagnostics for the DeepMentor CLI."""
...
from deepmentor.services.llm.utils import is_local_llm_server, sanitize_url
...
class DoctorCheck:
    """One diagnostic result shown by ``deepmentor doctor``."""
