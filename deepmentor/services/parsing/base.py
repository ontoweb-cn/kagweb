...
stage. An engine turns bytes/path into a :class:`~deepmentor.services.parsing.types.ParsedDocument`
...
class Parser(Protocol):
    ...
    def parse(
        ...
        *,
        ...
        workdir via :func:`deepmentor.services.parsing.cache.load_ir` and writes
