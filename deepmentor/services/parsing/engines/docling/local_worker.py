...
_WORKER_MODULE = "deepmentor.services.parsing.engines.docling.local_worker"
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="DeepMentor isolated Docling converter")
