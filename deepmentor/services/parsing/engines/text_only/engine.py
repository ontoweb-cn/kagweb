...
from deepmentor.runtime.isolated_worker import IsolatedWorkerError, run_in_isolated_process_sync
        ...
        *,
        ...
        try:
            run_in_isolated_process_sync(
                "deepmentor.runtime.worker_tasks:extract_document_to_markdown",
                str(source_path),
                str(output_path),
                kwargs={
