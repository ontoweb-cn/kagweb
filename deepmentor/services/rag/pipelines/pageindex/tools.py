"""Turn-scoped DeepMentor wrappers for PageIndex Cloud and OSS SDK tools."""
...
from deepmentor.core.tool_protocol import BaseTool, ToolDefinition, ToolLookup, ToolResult
...
def pageindex_sources_from_text(
    ...
    *,
    ...
    """Normalize real PageIndex page reads into DeepMentor source rows."""
    try:
