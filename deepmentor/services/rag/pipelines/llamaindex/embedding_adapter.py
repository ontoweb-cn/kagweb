"""LlamaIndex embedding adapter backed by DeepMentor's embedding service."""
...
from deepmentor.services.embedding import EmbeddingConfig, get_embedding_client, get_embedding_config
from deepmentor.services.embedding.validation import validate_embedding_batch
...
class CustomEmbedding(BaseEmbedding):
    """Custom LlamaIndex embedding adapter for DeepMentor embedding providers."""
...
def configure_llamaindex_settings(logger=None) -> None:
    """Configure LlamaIndex globals for DeepMentor's current embedding config."""
