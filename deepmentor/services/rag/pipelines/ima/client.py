...
A method table over the calls DeepMentor needs, with the wire mechanics delegated
to :class:`~deepmentor.services.rag.pipelines.ima.transport.ImaTransport`, the
