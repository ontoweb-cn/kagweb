...
def _get_adapter_class() -> type:
    ...
    with _CAPABILITY_LOCK:
        ...
        class DeepMentorLiteLLMCompletion(LiteLLMCompletion):
        ...
        _ADAPTER_CLASS = DeepMentorLiteLLMCompletion
        return _ADAPTER_CLASS


def register_completion_adapter() -> None:
    """Register DeepMentor's completion type through GraphRAG's public factory API."""
