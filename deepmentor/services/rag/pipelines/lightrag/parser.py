"""LightRAG parser that consumes frozen DeepMentor ingress bundles."""
...
class DeepMentorParser(BaseParser):
    """Third-party parser registered as ``deepmentor`` in LightRAG rc2."""

    engine_name = "deepmentor"
