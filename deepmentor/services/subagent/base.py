...
from deepmentor.services.subagent.types import ConsultResult, DetectResult, SubagentEvent
...
class SubagentBackend(ABC):
    ...
    async def consult(
        ...
        *,
        ...
        subagent keeps context across DeepMentor's successive questions); the
