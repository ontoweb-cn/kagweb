...
from deepmentor.services.memory import consolidator, paths, trace
from deepmentor.services.memory.consolidator import ConsolidateResult, OnEvent
from deepmentor.services.memory.document import Document, parse, serialize
from deepmentor.services.memory.ops import AddOp, ApplyReport, EditOp, OpResult
from deepmentor.services.memory.ops import apply as ops_apply
...
_NO_MEMORY = (
    "(No memory available — interact with DeepMentor and update from the Memory page to build one.)"
)
...
class MemoryStore:
    ...
    async def apply_ops_payload(
        ...
        """
        from deepmentor.services.memory.consolidator import _parse_ops_response
