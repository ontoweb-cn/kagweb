...
* :class:`ConsolidateResult`, :data:`OnEvent` — legacy types preserved
  for :mod:`deepmentor.services.memory.store`.
...
from deepmentor.services.memory.consolidator.guards import _filter_banned, _has_banned
from deepmentor.services.memory.consolidator.modes import (
    consolidate_l2,
    consolidate_l3,
    run_audit,
    run_dedup,
...
from deepmentor.services.memory.consolidator.parse import _parse_ops_response
