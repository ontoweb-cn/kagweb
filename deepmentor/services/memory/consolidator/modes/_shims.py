"""Legacy public-API shims for :mod:`deepmentor.services.memory.store`.
...
from deepmentor.services.memory.consolidator.modes.update import (
    UpdateResult,
    run_update,
)
from deepmentor.services.memory.document import parse, serialize
from deepmentor.services.memory.ops import ApplyReport, Op
