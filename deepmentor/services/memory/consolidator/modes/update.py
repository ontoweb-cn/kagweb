...
from deepmentor.services.memory import paths
from deepmentor.services.memory import snapshot as snap
from deepmentor.services.memory.consolidator.chunker import (
    chunk_with_boundary,
)
from deepmentor.services.memory.consolidator.meta import (
    load_l2_meta,
    load_l3_meta,
    save_l2_meta,
    save_l3_meta,
)
from deepmentor.services.memory.consolidator.modes._runtime import (
    OnEvent,
    call_llm,
    emit,
    load_doc,
...
from deepmentor.services.memory.consolidator.references import (
    ExtractedFact,
    refs_in_span_l2,
    refs_in_span_l3,
...
from deepmentor.services.memory.document import Document, Entry, serialize
from deepmentor.services.memory.ops import AddOp
from deepmentor.services.memory.ops import apply as apply_ops
from deepmentor.services.memory.paths import L3Slot, Surface
from deepmentor.services.memory.settings import load_memory_settings
    ...
    *,
    ...
    if not new_entities:
        ...
        if settings.merge.auto_after_update:
            from deepmentor.services.memory.consolidator.modes.merge import run_merge
    ...
    if settings.dedup.auto_after_update and facts_added > 0:
        ...
        from deepmentor.services.memory.consolidator.modes.dedup import run_dedup
...
def _load_all_l2_docs() -> dict[str, Document]:
    from deepmentor.services.memory.document import parse
