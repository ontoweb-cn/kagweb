...
def _render_l3(cap: int) -> str:
    ...
    Reads through :class:`~deepmentor.services.memory.store.MemoryStore`'s
...
def _collect_material(trace_count: int) -> _Material:
    ...
    nothing about that.
    """
    from deepmentor.services.memory import recall
...
async def _generate(language: str, material: _Material) -> SuggestionSet:
    ...
    try:
        ...
        from deepmentor.services.model_selection.tasks import task_llm_scope
