...
exec path in DeepMentor whose arguments are model-authored *and* whose program is
...
from deepmentor.services.cli_apps.paths import abi_stamp, bin_dir, executable_path, runtime_dir
from deepmentor.services.cli_apps.state import InstalledApp
from deepmentor.services.i18n import t
from deepmentor.services.sandbox.spec import ExecRequest, ExecResult, Mount, ResourceLimits
...
async def run_app(
    ...
    *,
    ...
    from deepmentor.services.sandbox import get_sandbox_service
