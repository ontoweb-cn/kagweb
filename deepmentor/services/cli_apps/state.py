...
from deepmentor.services.cli_apps.models import APP_ID_RE, AppRuntime, InstallKind
from deepmentor.services.cli_apps.paths import ensure_root, state_path
...
def prefs_path(owner_id: str) -> Path:
    ...
    """
    from deepmentor.multi_user.paths import SYSTEM_ROOT
