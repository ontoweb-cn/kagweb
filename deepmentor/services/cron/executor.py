...
from deepmentor.services.cron.service import CronJob
...
async def _maybe_send_desktop_notification(job: CronJob, text: str) -> None:
    ...
    DeepMentor still persists/delivers through its normal chat or partner
    ...
    title = f"DeepMentor: {job.name or 'Reminder'}"
