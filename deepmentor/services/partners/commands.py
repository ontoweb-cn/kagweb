...
BUILTIN_PARTNER_COMMANDS: tuple[PartnerCommandSpec, ...] = (
    ...
    PartnerCommandSpec(
        "/link",
        "Connect this chat account to your DeepMentor account.",
...
class PartnerCommandHandler:
    ...
    def _link(self, msg: InboundMessage, args: list[str]) -> PartnerCommandResult:
        ...
        if not args:
            return PartnerCommandResult(
                "Usage: /link <code>. Open this partner in DeepMentor and choose "
        ...
        if not user_id:
            return PartnerCommandResult(
                ...
                "Generate a fresh one in DeepMentor and try again."
            )
