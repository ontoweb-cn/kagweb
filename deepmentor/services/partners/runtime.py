...
from deepmentor.multi_user.paths import get_current_path_service, user_context
...
from deepmentor.partners.helpers import detect_image_mime
from deepmentor.services.partners.commands import PartnerCommandHandler
from deepmentor.services.partners.interaction import (
    actor_for_account,
...
from deepmentor.services.partners.links import linked_user_id
...
from deepmentor.services.partners.workspace import ensure_partner_workspace, read_soul
...
class PartnerRunner:
    ...
    def _identify(self, msg: InboundMessage) -> None:
        """Attach the sender's DeepMentor identity to a channel message, if any.
    ...
    async def _execute_turn(
        ...
        *,
        ...
        """
        from deepmentor.runtime.turn_engine import get_turn_engine
    ...
    def _build_context(
        ...
        *,
        ...
        metadata: dict[str, Any] = {
            ...
            # Swaps the system prompt's product identity ("You are DeepMentor")
    ...
    def _attachments_from_media(self, media: list[str]) -> tuple[list[Attachment], list[dict]]:
        ...
        if document_records:
            try:
                from deepmentor.utils.document_extractor import extract_documents_from_records
