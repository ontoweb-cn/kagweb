...
:class:`~deepmentor.services.mcp.config.MCPServerConfig`, the only server shape
the rest of DeepMentor understands.
...
:mod:`deepmentor.services.mcp.secrets` resolves in memory at connect time. That
...
from deepmentor.services.mcp.secrets import secret_reference
