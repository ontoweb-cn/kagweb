...
from deepmentor.services.session.artifact_attachments import (
...
if TYPE_CHECKING:
    from deepmentor.runtime.coordination import RuntimeCoordinator
...
class TurnExecutor:
    ...
    async def _run_turn(self, execution: _TurnExecution) -> None:
        ...
        try:
            from deepmentor.agents.notebook import NotebookAnalysisAgent
            from deepmentor.book.context import build_book_context
            from deepmentor.core.context import Attachment, TurnRuntimeContext, UnifiedContext
            ...
            from deepmentor.services.storage import get_attachment_store
            ...
            if not current_user.is_admin:
                ...
                from deepmentor.multi_user.learner_profile import prompt_block
            ...
            from deepmentor.runtime.memory_reclaim import schedule_memory_reclaim
