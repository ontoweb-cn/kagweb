...
class TurnRequestPreparer:
    ...
    async def start_turn(self, payload: dict[str, Any]) -> tuple[dict[str, Any], dict[str, Any]]:
        ...
        if per_turn_auto_route is None:
            from deepmentor.services.config.runtime_settings import load_system_settings
        ...
        try:
            from deepmentor.runtime.request_contracts import validate_capability_config
        ...
        if llm_selection:
            ...
            from deepmentor.multi_user.model_access import (
        ...
        # capability's turn.
        from deepmentor.multi_user.tool_access import allowed_optional_tools
