...
async def _book_index() -> ResourceIndex:
    from deepmentor.book.engine import get_book_engine
...
async def _notebook_index() -> ResourceIndex:
    from deepmentor.services.notebook.service import get_notebook_manager
...
async def _resource_indexes() -> dict[str, ResourceIndex]:
    from deepmentor.services.courses import COURSE_RESOURCE_KINDS
...
async def _session_state(course_id: str) -> tuple[dict[str, Any], set[str]]:
    ...
    try:
        ...
        from deepmentor.services.session.organization import list_all_sessions_snapshot
...
async def build_course_state(course_id: str) -> dict[str, Any]:
    ...
    from deepmentor.services.courses import get_course_service
