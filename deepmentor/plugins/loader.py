"""Neutral plugin discovery for DeepMentor.

External packages register under the ``deepmentor.plugins`` entry-point group.
...
ENTRY_POINT_GROUP = "deepmentor.plugins"
...
def discover_plugins() -> list[PluginManifest]:
    """Discover plugins registered via ``deepmentor.plugins`` entry points."""
