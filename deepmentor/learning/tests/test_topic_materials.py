...
from deepmentor.learning.topic_materials import (
...
def two_chapter_book(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("deepmentor.book.storage.get_book_storage", lambda: _book_storage(chapters))
    monkeypatch.setattr(
...
def test_one_failing_material_never_takes_the_turn_down(
    ...
    monkeypatch.setattr("deepmentor.services.notebook.get_notebook_manager", _explode)
