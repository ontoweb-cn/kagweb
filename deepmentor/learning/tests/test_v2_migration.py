...
import deepmentor.learning.migration as migration_module
from deepmentor.learning.migration import prepare_mastery_v2_root
from deepmentor.learning.models import LearningProgress, MasteryInteraction, PendingQuestion
...
def test_corrupt_live_json_is_quarantined_without_blocking_good_migration(
    ...
    with caplog.at_level(logging.ERROR, logger="deepmentor.learning.storage"):
        v2_root = prepare_mastery_v2_root(learning_root)
