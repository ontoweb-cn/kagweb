...
:class:`~deepmentor.capabilities.explore_context.ExploreContextCapability`'s
...
:class:`~deepmentor.capabilities.mastery.loop.MasteryLoopCapability`) are wired
up in :mod:`deepmentor.services.session.turn_runtime`.
