...
from deepmentor.services.file_io import atomic_write_text as _atomic_write_text
...
class LearningStore:
    ...
    def __init__(self, root: Path | None = None) -> None:
        if root is None:
            ...
            from deepmentor.learning.migration import prepare_mastery_v2_root
    ...
    def save(self, progress: LearningProgress) -> None:
        ...
        from deepmentor.learning.event_hub import publish_topic_signal
    ...
    def default_db_path() -> Path:
        ...
        """
        from deepmentor.learning.migration import mastery_v2_root
