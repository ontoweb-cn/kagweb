...
async def _ground_file_source(source: TopicSource) -> TopicSource:
    ...
    try:
        from deepmentor.multi_user.knowledge_access import resolve_kb_document_path
        from deepmentor.utils.document_extractor import extract_text_from_path_isolated
