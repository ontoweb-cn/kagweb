...
from deepmentor.learning.pending import PublicPendingQuestion, public_pending_question
...
def path_display_name(progress: LearningProgress) -> str:
    ...
    A path's own :attr:`~deepmentor.learning.models.LearningProgress.name` wins.
