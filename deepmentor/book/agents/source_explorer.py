...
class SourceExplorer(BaseAgent):
    ...
    def __init__(
        ...
        # deepmentor/agents/research/pipeline.py:403.
    ...
    def partition_knowledge_bases(kb_list: list[str]) -> tuple[list[str], list[str]]:
        ...
        for kb in kb_list:
            try:
                from deepmentor.knowledge.kb_types import supports_rag_retrieval
    ...
    def _collect_non_kb_chunks(self, inputs: BookInputs) -> list[SourceChunk]:
        ...
        try:
            if inputs.notebook_refs:
                from deepmentor.services.notebook import notebook_manager
