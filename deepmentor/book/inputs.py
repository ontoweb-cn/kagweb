...
Reuses:
- ``deepmentor.services.session.get_sqlite_session_store`` for chat history
- ``deepmentor.services.notebook.notebook_manager`` for notebook records
- ``deepmentor.agents.notebook.NotebookAnalysisAgent`` for context distillation
"""
