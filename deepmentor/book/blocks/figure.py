...
Wraps :class:`deepmentor.agents.visualize.pipeline.VisualizePipeline` with
...
class FigureGenerator(BlockGenerator):
    ...
    async def _generate(
        ...
        try:
            from deepmentor.agents.visualize.models import ReviewResult
            from deepmentor.agents.visualize.pipeline import VisualizePipeline
            from deepmentor.agents.visualize.utils import validate_visualization
