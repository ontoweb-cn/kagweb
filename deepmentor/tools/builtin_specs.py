"""Import-cheap catalog for DeepMentor's built-in tools.
...
from deepmentor.core.tool_protocol import BaseTool
...
BUILTIN_TOOL_SPECS: tuple[BuiltinToolSpec, ...] = (
    *_specs(
    ...
    BuiltinToolSpec("exec", "deepmentor.tools.exec_tool:ExecTool"),
    BuiltinToolSpec("submit_visualization", "deepmentor.visualizers.tool:SubmitVisualizationTool"),
    BuiltinToolSpec("imagegen", "deepmentor.tools.media_gen_tool:ImagegenTool"),
    BuiltinToolSpec("videogen", "deepmentor.tools.media_gen_tool:VideogenTool"),
    *_specs(
        "deepmentor.tools.mastery_nav",
        (
    ...
    *_specs(
        "deepmentor.capabilities.mastery.tools",
        (
    ...
    *_specs(
        "deepmentor.capabilities.solve.tools",
        (
    ...
    *_specs(
        "deepmentor.capabilities.obsidian.tools",
        (
    ...
    *_specs(
        "deepmentor.capabilities.marginnote4.tools",
        (
    ...
    BuiltinToolSpec(
        "consult_subagent", "deepmentor.capabilities.subagent.tools:ConsultSubagentTool"
    ),
    *_specs(
        "deepmentor.capabilities.ima.tools",
        (
    ...
    *_specs(
        "deepmentor.capabilities.reading.tools",
        (
    ...
    *_specs(
        "deepmentor.capabilities.setup.tools",
        (
    ...
    BuiltinToolSpec(
        "propose_partner", "deepmentor.capabilities.partner_authoring.tools:ProposePartnerTool"
    ),
    BuiltinToolSpec("invoke_other", "deepmentor.capabilities.partner_group.tools:InvokeOtherTool"),
    *_specs(
        "deepmentor.capabilities.course_study.tools",
        (
    ...
    *_specs(
        "deepmentor.tools.partner_memory",
        (
