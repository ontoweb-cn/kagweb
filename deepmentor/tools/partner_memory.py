...
def _concat_l3() -> str:
    ...
    """
    from deepmentor.services.memory import get_memory_store, paths
...
class PartnerReadTool(BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from deepmentor.multi_user.paths import get_admin_path_service, get_current_path_service
        from deepmentor.services.memory import memory_path_service_override
        from deepmentor.services.partners.interaction import get_partner_turn_context
...
class PartnerMemorizeTool(BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from deepmentor.multi_user.paths import get_current_path_service
        from deepmentor.services.memory import get_memory_store, memory_path_service_override
...
class PartnerSearchTool(BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from deepmentor.partners.config.paths import get_partner_sessions_dir
        from deepmentor.services.partners.interaction import get_partner_turn_context
