...
runs through the :mod:`deepmentor.services.sandbox` layer rather than a raw
...
# NOTE: ``deepmentor.services.sandbox`` is imported lazily inside ``execute``
# (not at module top). This tool is loaded by ``deepmentor.tools.builtin``,
