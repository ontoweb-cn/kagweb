...
Centralized file type classification for chat attachments and document
parsing. Originally built for the knowledge-base pipeline; the chat
attachment extractor shares its extension sets and decoding chain.
"""
...
class FileTypeRouter:
    ...
    def get_parser_extensions(cls) -> set[str]:
        ...
        """
        from deepmentor.services.parsing.engines.formats import known_parser_formats
    ...
    def active_parser_accepts_any_format(cls) -> bool:
        ...
        try:
            from deepmentor.services.parsing.engines.factory import get_parser
            from deepmentor.services.parsing.service import get_parse_service
