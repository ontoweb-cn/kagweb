...
from deepmentor.utils.secret_files import ensure_private_directory, ensure_private_file
...
_CONFIGURED = False
_MANAGED_ATTR = "_deepmentor_managed"
...
def configure_logging(force: bool = False) -> LoggingConfig:
    ...
    if config.file_output:
        ...
        log_path = log_dir / "deepmentor.jsonl"
    ...
    logging.getLogger("deepmentor").setLevel(logging.DEBUG)
    logging.getLogger("deepmentor").propagate = True
