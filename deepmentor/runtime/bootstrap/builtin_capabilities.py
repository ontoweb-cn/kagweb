...
BUILTIN_CAPABILITY_CLASSES: dict[str, str] = {
    "chat": "deepmentor.agents.chat.capability:ChatCapability",
    "ask_questions": ("deepmentor.capabilities.ask_questions.capability:AskQuestionsCapability"),
    "deep_solve": "deepmentor.capabilities.solve.capability:DeepSolveCapability",
    "deep_question": "deepmentor.agents.question.capability:DeepQuestionCapability",
    "deep_research": "deepmentor.agents.research.capability:DeepResearchCapability",
    "math_animator": "deepmentor.agents.math_animator.capability:MathAnimatorCapability",
    "visualize": "deepmentor.agents.visualize.capability:VisualizeCapability",
    "mastery_path": "deepmentor.capabilities.mastery.capability:MasteryPathCapability",
    "immersive_reading": "deepmentor.capabilities.reading.mode:ImmersiveReadingCapability",
    "course_study": "deepmentor.capabilities.course_study.mode:CourseStudyCapability",
    "immersive_watching": "deepmentor.capabilities.watching.mode:ImmersiveWatchingCapability",
}
