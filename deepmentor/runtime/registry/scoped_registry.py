...
Two things the process-global :class:`~deepmentor.runtime.registry.tool_registry.ToolRegistry`
...
from deepmentor.tools.prompting import compose_prompt_text
...
class ScopedToolRegistry:
    ...
    Satisfies :class:`~deepmentor.core.tool_protocol.ToolLookup`. Intentionally
