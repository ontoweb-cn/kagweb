...
from deepmentor.core.capability_protocol import TurnCapability
from deepmentor.core.entry_points import load_entry_point_group
from deepmentor.i18n.metadata_i18n import capability_description_i18n
from deepmentor.runtime.bootstrap.builtin_capabilities import BUILTIN_CAPABILITY_SPECS
from deepmentor.runtime.capability_catalog import (
    CapabilityCatalog,
    EmptyConfig,
    get_capability_catalog,
)
from deepmentor.runtime.request_contracts import CAPABILITY_CONFIG_MODELS

logger = logging.getLogger(__name__)

EXTENSIONS_GROUP = "deepmentor.extensions"
LEGACY_PLUGINS_GROUP = "deepmentor.plugins"
...
class CapabilityRegistry:
    ...
    def load_plugins(self) -> None:
        ...
        try:
            module = importlib.import_module("deepmentor.plugins.loader")
