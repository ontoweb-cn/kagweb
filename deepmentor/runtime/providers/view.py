...
async def _build(
    *,
    ...
    from deepmentor.services.mcp import get_mcp_manager, load_loaded_tools
...
def _user_grant(scope: ToolScope) -> Allowlist:
    ...
    from deepmentor.multi_user.tool_access import allowed_mcp_tools
