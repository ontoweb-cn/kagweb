...
from deepmentor.core.tool_protocol import ToolLookup, provider_identity
...
from deepmentor.runtime.agentic.tool_arg_guard import (
...
async def _reject_if_args_missing(
    *,
    ...
    fill in. See :mod:`deepmentor.runtime.agentic.tool_arg_guard` for why the
