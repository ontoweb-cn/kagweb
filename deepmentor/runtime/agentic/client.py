...
from deepmentor.services.config import load_system_settings
from deepmentor.services.keypool import KeyPool, primary_api_key
from deepmentor.services.llm import get_token_limit_kwargs, supports_tools
from deepmentor.services.llm.capabilities import catalog_capability_override
from deepmentor.services.llm.openai_http_client import (
...
def _build_openai_client(
    ...
    *,
    ...
    if wire_api == "responses":
        from deepmentor.services.llm.provider_core import OpenAICompatProvider
...
def _build_anthropic_adapter(config: LLMClientConfig, spec: Any) -> Any:
    from deepmentor.services.llm.provider_core import AnthropicProvider
...
def _build_codex_adapter(config: LLMClientConfig, spec: Any) -> Any:
    from deepmentor.services.codex_auth.constants import CODEX_DEFAULT_MODEL_ID
    from deepmentor.services.llm.provider_core import OpenAICodexProvider
...
def _build_copilot_adapter(config: LLMClientConfig, spec: Any) -> Any:
    from deepmentor.services.llm.provider_core import GitHubCopilotProvider
