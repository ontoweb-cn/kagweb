...
:func:`~deepmentor.runtime.agentic.labeled_step.run_labeled_step` call, after
which the loop:
...
from deepmentor.runtime.agentic.labeled_step import LabeledStepResult, run_labeled_step
from deepmentor.runtime.agentic.labels import LABEL_UNKNOWN, find_inline_labels
