...
class DeepMentorError(Exception):
    """Base class for all application errors in DeepMentor."""
...
class ConfigurationError(DeepMentorError):
    """Raised when there's a configuration-related error."""

    pass


class ValidationError(DeepMentorError):
    """Raised when input validation fails."""

    pass


class ServiceError(DeepMentorError):
