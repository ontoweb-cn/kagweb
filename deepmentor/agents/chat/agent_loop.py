...
from deepmentor.agents.chat.context_budget import LLMRequestSnapshot
from deepmentor.agents.chat.dsml_tool_calls import DSMLStreamFilter, extract_dsml_tool_calls
...
from deepmentor.runtime.agentic.messages import assistant_message_with_tool_calls
from deepmentor.runtime.agentic.tool_call_stream import ToolCallAccumulator
from deepmentor.runtime.agentic.tool_dispatch import DispatchOutcome
from deepmentor.runtime.agentic.usage import message_content_chars, record_streamed_usage
from deepmentor.runtime.stream_bus import StreamBus
from deepmentor.services.llm import LLMProviderTransportError, clean_thinking_tags
from deepmentor.services.llm.capabilities import threads_session_id
from deepmentor.services.llm.multimodal import should_degrade_to_text, strip_image_parts_inplace
    ...
    async def _call_llm(
        ...
        *,
        ...
        if threads_session_id(self.pipeline.binding):
            kwargs["deepmentor_session_id"] = self.context.session_id
