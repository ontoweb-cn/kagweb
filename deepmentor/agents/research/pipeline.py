...
from deepmentor.agents._shared.capability_result import emit_capability_result
...
from deepmentor.agents.research.data_structures import (
    DynamicTopicQueue,
    ToolTrace,
    TopicBlock,
    TopicStatus,
)
from deepmentor.agents.research.utils.citation_manager import CitationManager
...
from deepmentor.runtime.agentic.tool_dispatch import (
...
from deepmentor.services.llm import get_llm_config, prepare_multimodal_messages
from deepmentor.services.path_service import get_path_service
from deepmentor.services.prompt import get_prompt_manager
from deepmentor.services.prompt.language import append_language_directive
from deepmentor.services.sandbox import exec_capability_available
...
class ResearchPipeline:
    ...
    LLM call goes through :mod:`deepmentor.runtime.agentic` primitives. The
    ...
    def __init__(
        ...
        *,
        ...
        if self.kb_name:
            try:
                from deepmentor.knowledge.kb_types import OBSIDIAN_KB_TYPE
                from deepmentor.multi_user.knowledge_access import resolve_kb_metadata
    ...
    async def _prepare_pageindex_tools(self) -> None:
        from deepmentor.services.rag.pipelines.pageindex.tools import (
...
class _RephraseLoopHost:
    ...
    async def resolve_pause(self, dispatch: DispatchOutcome) -> bool:
        from deepmentor.agents.chat.agentic_pipeline import (
