...
from deepmentor.core.trace import merge_trace_metadata
from deepmentor.i18n import StatusI18n
from deepmentor.runtime.agentic.usage import UsageTracker
from deepmentor.runtime.request_contracts import (
...
from deepmentor.visualizers.protocol import (
    REQUESTED_VISUALIZER_KEY,
    VISUALIZATION_RESULT_KEY,
    VISUALIZE_MODE_KEY,
)
from deepmentor.visualizers.registry import get_visualizer_registry
from deepmentor.visualizers.store import VisualizerStoreError
        ...
        *,
        ...
        if importlib.util.find_spec("manim") is None:
            raise RuntimeError(
                ...
                "Install with `pip install 'deepmentor[math-animator]'` "
                "or `pip install -r requirements/math-animator.txt`."
            )

        from deepmentor.agents.math_animator.pipeline import MathAnimatorPipeline
        from deepmentor.agents.math_animator.request_config import MathAnimatorRequestConfig
        from deepmentor.core.trace import build_trace_metadata, new_call_id
        from deepmentor.services.llm.config import get_llm_config
