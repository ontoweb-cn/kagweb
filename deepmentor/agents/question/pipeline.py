...
to :mod:`deepmentor.runtime.agentic` and the shared tool-composition policy.
"""
...
from deepmentor.runtime.agentic.labels import find_inline_labels
from deepmentor.runtime.agentic.tool_dispatch import MAX_PARALLEL_TOOL_CALLS
from deepmentor.runtime.agentic.usage import record_streamed_usage
    ...
    async def _summarize_tool_result(
        ...
        *,
        ...
        meta = build_trace_metadata(
            ...
            label=self._t("labels.reflecting", default="DeepMentor Reflecting..."),
        ...
        await stream.progress(
            self._t("labels.reflecting", default="DeepMentor Reflecting..."),
            source=SOURCE,
            stage=STAGE_EXPLORING,
