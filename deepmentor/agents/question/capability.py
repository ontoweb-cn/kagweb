...
class DeepQuestionCapability(TurnCapability):
    ...
    async def run(self, context: UnifiedContext, stream: StreamBus) -> None:
        ...
        if isinstance(followup_question_context, dict) and followup_question_context.get(
            ...
            from deepmentor.agents.question.agents.followup_agent import FollowupAgent
        ...
        if mode != "mimic":
            ...
            from deepmentor.agents.question.history import load_session_quiz_history
            from deepmentor.agents.question.pipeline import QuestionPipeline
            from deepmentor.agents.question.request_config import (
    ...
    async def _run_mimic_mode(
        ...
        * ``[Attached Documents]`` in  → no paper available; fall back to
        ...
        """
        from deepmentor.agents.question.history import load_session_quiz_history
        from deepmentor.agents.question.mimic_source import (
        ...
        from deepmentor.services.config import load_config_with_main
        from deepmentor.services.parsing.engines.mineru.config import MinerUError
