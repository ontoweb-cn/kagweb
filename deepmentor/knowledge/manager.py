...
from deepmentor.knowledge.kb_types import (
    IMA_KB_TYPE,
...
from deepmentor.knowledge.manifest import iter_kb_documents
...
from deepmentor.services.rag.index_probe import (
    inspect_kb_versions,
    inspect_provider_version,
    provider_failure_summary,
)
from deepmentor.services.web_source.crawler import MAX_CRAWL_DEPTH, MAX_CRAWL_PAGES
...
class KnowledgeBaseManager:
    ...
    def update_kb_status(
        ...
        if status == "ready":
            ...
            try:
                from deepmentor.services.rag.embedding_signature import (
    ...
    def _marginnote4_store_owner(
        ...
        from deepmentor.capabilities.marginnote4.store import resolve_db_path
        ...
        *,
        ...
        if dir_exists:
            try:
                ...
                # counts for the same KB (see :mod:`deepmentor.knowledge.manifest`).
