...
from deepmentor.partners.config.schema import Base, DeliveryOverrides
...
SLACK_SOCKET_CONNECT_TIMEOUT_S = 30.0
...
class SlackConfig(DeliveryOverrides):
...
class SlackChannel(BaseChannel):
    ...
    async def send(self, msg: OutboundMessage) -> None:
        ...
        Raises on text-delivery failure so the channel manager's retry
        policy applies; per-file upload failures stay best-effort.
        """
