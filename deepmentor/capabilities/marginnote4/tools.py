...
(via :class:`~deepmentor.capabilities.marginnote4.capability.MarginNoteCapability`,
...
:class:`~deepmentor.capabilities.marginnote4.store.MarginNoteStore` methods.
...
from deepmentor.capabilities.marginnote4.models import ALL_TYPES
from deepmentor.capabilities.marginnote4.store import MarginNoteStore
