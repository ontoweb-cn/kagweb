...
library (resolved by :mod:`deepmentor.capabilities.marginnote4.binding`). As a
...
from deepmentor.capabilities.marginnote4.binding import (
    marginnote_binding,
    marginnote_kb_refs,
)
from deepmentor.capabilities.marginnote4.tools import MARGINNOTE_TOOL_NAMES
