...
:mod:`deepmentor.capabilities` (``solve``, ``mastery``). The chat loop imports
...
from deepmentor.capabilities.protocol import KnowledgeCapability, LoopExtension, PromptBlock
