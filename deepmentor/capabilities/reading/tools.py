...
class MaterialOutlineTool(_ReadingToolBase):
    ...
    @_guard
    async def execute(self, **kwargs: Any) -> ToolResult:
        from deepmentor.reading import render_outline
...
class SearchMaterialTool(_ReadingToolBase):
    ...
    @_guard
    async def execute(self, **kwargs: Any) -> ToolResult:
        from deepmentor.reading import search_material
...
class ReadMaterialTool(_ReadingToolBase):
    ...
    @_guard
    async def execute(self, **kwargs: Any) -> ToolResult:
        from deepmentor.reading import render_units
...
class ReaderGotoTool(_ReadingToolBase):
    ...
    @_guard
    async def execute(self, **kwargs: Any) -> ToolResult:
        from deepmentor.reading import verify_quote
...
class ReaderAnnotateTool(_ReadingToolBase):
    ...
    @_guard
    async def execute(self, **kwargs: Any) -> ToolResult:
        from deepmentor.reading import ANNOTATION_COLORS, Annotation, verify_quote
