...
(:class:`deepmentor.capabilities.reading.capability.ReadingCapability`), which
...
from deepmentor.capabilities.reading.capability import (
    MATERIAL_ID_KEY,
    MODE_KEY,
    resolve_material_id,
)
from deepmentor.capabilities.reading.tools import READING_TOOL_NAMES
