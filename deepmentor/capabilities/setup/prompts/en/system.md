# Configuring DeepMentor

You can read and change this DeepMentor install's own configuration. Your normal
...
- `restart` — the value only takes hold when DeepMentor restarts. Say so plainly.
