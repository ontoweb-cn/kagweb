"""Setup loop capability — DeepMentor configuring its own install.

A *plain* :class:`~deepmentor.capabilities.protocol.LoopExtension`, not a
:class:`~deepmentor.capabilities.protocol.KnowledgeCapability`: configuring the
...
Activation is decided by :func:`~deepmentor.capabilities.setup.binding.is_setup_turn`
...
from deepmentor.capabilities.protocol import PromptBlock
from deepmentor.capabilities.setup.binding import (
...
from deepmentor.capabilities.setup.tools import SETUP_TOOL_NAMES
from deepmentor.core.context import UnifiedContext


class SetupCapability:
    """Turn-scoped ability to inspect and change DeepMentor's own configuration."""
