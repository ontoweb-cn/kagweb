...
:class:`~deepmentor.capabilities.obsidian.capability.ObsidianCapability`, which
...
:mod:`deepmentor.capabilities.obsidian.vault` operations.
...
from deepmentor.capabilities.obsidian import vault as vault_ops
