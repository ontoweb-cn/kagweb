...
vault (resolved by :mod:`deepmentor.capabilities.obsidian.binding`). As a
...
from deepmentor.capabilities.obsidian.binding import obsidian_vault_refs, vault_for_turn
from deepmentor.capabilities.obsidian.tools import OBSIDIAN_TOOL_NAMES
