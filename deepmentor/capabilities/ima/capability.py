...
IMA library (resolved by :mod:`deepmentor.capabilities.ima.binding`).

Unlike the Obsidian and subagent capabilities this is a *plain*
:class:`~deepmentor.capabilities.protocol.LoopExtension`, not a
:class:`~deepmentor.capabilities.protocol.KnowledgeCapability`: it **adds** its
...
from deepmentor.capabilities.ima.binding import ima_bindings
from deepmentor.capabilities.ima.tools import BINDINGS_KWARG, IMA_TOOL_NAMES
