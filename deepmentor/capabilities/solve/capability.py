...
(:class:`deepmentor.capabilities.solve.loop.SolveLoopCapability`) mounts the
...
from deepmentor.capabilities.solve.session import DEFAULT_MAX_REPLANS
from deepmentor.capabilities.solve.tools import SOLVE_TOOL_NAMES
...
from deepmentor.services.config.capabilities_settings import get_solve_params
