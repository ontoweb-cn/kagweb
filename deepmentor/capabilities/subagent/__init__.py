...
through :mod:`deepmentor.services.subagent` and streaming its native run to the
...
from deepmentor.capabilities.subagent.binding import connection_for_turn
from deepmentor.capabilities.subagent.capability import SubagentCapability
from deepmentor.capabilities.subagent.tools import (
    SUBAGENT_TOOL_NAMES,
    SUBAGENT_TOOL_TYPES,
    ConsultSubagentTool,
)
