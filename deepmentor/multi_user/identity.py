...
from deepmentor.services.file_io import atomic_write_text
from deepmentor.utils.secret_files import write_secret_text
...
# process FastAPI deployments (the ``deepmentor start`` launcher) are fully covered;
...
def _env_bootstrap_admin() -> tuple[str, str]:
    ...
    :mod:`deepmentor.services.auth` is imported lazily because it imports this
