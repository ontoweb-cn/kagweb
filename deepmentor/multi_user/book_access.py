...
from deepmentor.book.learning_overlay import BookLearningOverlay
from deepmentor.book.models import Book, Progress
from deepmentor.book.storage import BookStorage, get_book_storage
...
if TYPE_CHECKING:
    from deepmentor.book.engine import BookEngine
...
def resolve_book(book_id: str) -> ResolvedBook | None:
    ...
    from deepmentor.book.engine import BookEngine, get_book_engine
