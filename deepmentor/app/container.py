...
from deepmentor.runtime.capability_catalog import get_capability_catalog
...
from deepmentor.runtime.registry.capability_registry import CapabilityRegistry
from deepmentor.runtime.turn_engine import TurnEngine
from deepmentor.services.config import load_integrations_settings, load_system_settings
...
from deepmentor.services.session.scope import store_scope
...
class ApplicationContainer:
    ...
    def _local_users() -> list[Any]:
        ...
        from deepmentor.multi_user.paths import local_admin_user, scope_for_user
    ...
    async def migrate_legacy_chat(self, *, dry_run: bool = False) -> dict[str, Any]:
        ...
        from deepmentor.services.session.legacy_migration import (
    ...
    async def migrate_all_workspace_preferences(self) -> list[dict[str, Any]]:
        ...
        from deepmentor.multi_user.identity import list_user_info
        from deepmentor.multi_user.models import CurrentUser
        from deepmentor.multi_user.paths import local_admin_user, scope_for_user, user_context
