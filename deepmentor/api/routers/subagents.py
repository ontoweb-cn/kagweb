...
from deepmentor.knowledge.kb_types import SUBAGENT_KB_TYPE
from deepmentor.multi_user.knowledge_access import current_kb_manager
from deepmentor.multi_user.partner_access import assert_partner_allowed, visible_partner_cards
from deepmentor.services.rag.linked_kb import assert_path_allowed
from deepmentor.services.subagent import (
...
async def backend_options():
    ...
    from deepmentor.services.subagent.models import list_backend_options
...
async def sync_backend(kind: str):
    ...
    """
    from deepmentor.services.subagent import get_backend
    from deepmentor.services.subagent.models import sync_backend_options
...
async def delete_connection(name: str):
    ...
    from deepmentor.services.subagent.sessions import forget_connection
...
async def message_connection(name: str, payload: SubagentMessageRequest):
    ...
    from deepmentor.services.subagent import get_backend
    from deepmentor.services.subagent.sessions import get_session, remember_session, session_key
