...
Why live here vs inside ``deepmentor.partners.channels``?
...
from deepmentor.services.partners.manager import _is_secret_field
...
def all_channel_schemas() -> dict[str, dict[str, Any]]:
    ...
    """
    from deepmentor.partners.channels.registry import discover_all_with_errors
