...
from deepmentor.core.tool_protocol import BaseTool, ToolDefinition, ToolPromptHints
from deepmentor.i18n.metadata_i18n import tool_description_i18n
from deepmentor.services.config import resolve_search_runtime_config
...
async def list_builtin_tools() -> ToolsListResponse:
    ...
    from deepmentor.capabilities import capability_tool_owners
