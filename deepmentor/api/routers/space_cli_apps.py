...
from deepmentor.services.cli_apps import (
    CliAppEntry,
    catalog_pin,
    category_counts,
    get_entry,
...
async def install(app_id: str) -> dict[str, Any]:
    ...
    from deepmentor.services.cli_apps.installer import install_app
...
async def uninstall(app_id: str) -> dict[str, Any]:
    ...
    from deepmentor.services.cli_apps.installer import uninstall_app
