...
from deepmentor.services.courses_state import (
...
async def update_course(course_id: str, payload: UpdateCourseRequest) -> dict[str, object]:
    from deepmentor.services.courses import COURSE_STATUSES
...
async def update_syllabus_unit(
    ...
    from deepmentor.services.courses import SyllabusUnitNotFoundError
