...
async def mimic_exam_questions(*args, **kwargs):
    ...
    from deepmentor.tools.question import mimic_exam_questions as run
                ...
                if clean_message:
                    try:
                        event = ProcessLogEvent(
                            ...
                            logger="deepmentor.question.stdout",
...
async def websocket_question_generate(websocket: WebSocket):
    from deepmentor.agents.question import AgentCoordinator
    from deepmentor.api.routers.auth import ws_auth_failed, ws_require_auth
    from deepmentor.multi_user.context import reset_current_user
