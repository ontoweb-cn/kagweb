...
from deepmentor.services.mcp import MCPServerConfig, get_mcp_manager, load_mcp_config, oauth
from deepmentor.services.mcp.catalog import (
    build_server_config,
    category_counts,
    get_entry,
    search_catalog,
...
from deepmentor.services.mcp.secrets import configured_fields, delete_secrets, store_secrets
...
def _extract_credentials(
    ...
    """
    from deepmentor.services.mcp.secrets import SECRET_REFERENCE_RE, secret_reference
