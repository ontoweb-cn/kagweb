...
come from :mod:`deepmentor.services.suggestions`, which reads memory.
...
async def get_starter_suggestions():
    ...
    """
    from deepmentor.services.suggestions import get_suggestions
...
async def refresh_starter_suggestions():
    ...
    different set.
    """
    from deepmentor.services.suggestions import refresh_suggestions
