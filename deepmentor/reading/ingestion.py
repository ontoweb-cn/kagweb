...
from deepmentor.reading.extract import split_markdown_by_headings
from deepmentor.reading.models import OutlineEntry, ReadingError, UnitReference
from deepmentor.reading.store import ReadingStore, content_hash
from deepmentor.services.web_source.markdown import strip_leading_snapshot_provenance
from deepmentor.services.web_source.snapshot_assets import (
    ImageFetcher,
    localize_snapshot_images,
)
from deepmentor.tools.web_fetch import FetchOutcome, fetch_url_as_markdown
...
async def _load_bilibili_media(url: str, languages: Sequence[str]) -> BilibiliMedia:
    ...
    headers = {
        ...
        "User-Agent": "Mozilla/5.0 DeepMentor/ImmersiveReading",
    }
