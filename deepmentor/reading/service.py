...
chat loop or the LLM; it takes a :class:`~deepmentor.reading.store.ReadingStore`
...
from deepmentor.reading.models import MaterialManifest, OutlineEntry, ReadingError
from deepmentor.reading.search import SearchResult, locate_quote, search_units
from deepmentor.reading.store import MAX_READ_CHARS, ReadingStore
...
def render_units(
    ...
    *,
    ...
    (``--- Page 12 ---``), so a model that has seen a DeepMentor attachment
